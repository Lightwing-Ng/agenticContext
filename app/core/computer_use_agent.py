...
from . import browser_host as _browser_host
from .token_usage import tiktoken as tiktoken
...
from .agent import browser_transport as _browser_transport
from .agent.context_package import _format_binary_size, build_context_markdown
from .agent.platform_catalog import (
    AGENT_MODEL_OPTIONS_BY_PLATFORM as AGENT_MODEL_OPTIONS_BY_PLATFORM,
    AGENT_PLATFORM_BY_KEY,
    AGENT_PLATFORM_OPTIONS as AGENT_PLATFORM_OPTIONS,
    BROWSER_OPTIONS,
    CHATGPT_HOME_URL,
    CHATGPT_HOSTS,
    ...
    OPERATING_SYSTEM_OPTIONS as OPERATING_SYSTEM_OPTIONS,
    SUPPORTED_AGENT_PLATFORMS,
    SUPPORTED_AGENT_SESSION_MODES,
    SUPPORTED_BROWSERS,
    SUPPORTED_OPERATING_SYSTEMS,
    SUPPORTED_SAFARI_AGENT_EXECUTION_PLATFORMS,
    SUPPORTED_SAFARI_AGENT_PLATFORMS as SUPPORTED_SAFARI_AGENT_PLATFORMS,
    SUPPORTED_SAFARI_WEB_SESSION_PLATFORMS,
    _platform_home_url,
    _platform_hosts,
    _platform_model_options,
    default_model_for_platform,
    detect_host_operating_system,
    strongest_model_option as strongest_model_option,
)
from .agent.action_protocol import (
    activity_detail as _activity_detail,
    parse_agent_action,
    render_final_action as _render_final_action,
)
...
from .workspace.action_state import (
    ActionState,
    _MAX_AGENT_RUN_REVISION,
)
from .workspace.controller import (
    DEFAULT_AGENT_RUNTIME_ROOT,
    MAX_BASE64_DECODED_BYTES as MAX_BASE64_DECODED_BYTES,
    MAX_CONTROLLER_DELETE_BYTES as MAX_CONTROLLER_DELETE_BYTES,
    WorkspaceController,
    _ANCHORED_DELETE_SUPPORTED as _ANCHORED_DELETE_SUPPORTED,
    _ANCHORED_MUTATION_SUPPORTED as _ANCHORED_MUTATION_SUPPORTED,
    _registered_action_capability,
)
from .workspace.command_policy import (
    inspection_command_parts as inspection_command_parts,
    validate_inspection_command as validate_inspection_command,
)
from .workspace.evidence import (
    WORKSPACE_FINGERPRINT_TIMEOUT_SECONDS,
    _bounded_git_status_output as _bounded_git_status_output,
    _workspace_mutation_fingerprint as _workspace_mutation_fingerprint,
)
from .workspace.executables import (
    _trusted_system_executable as _trusted_system_executable,
)
from .workspace.paths import (
    _collect_instruction_files as _collect_instruction_files,
    _path_has_controller_internal_file as _path_has_controller_internal_file,
    _path_has_sensitive_part as _path_has_sensitive_part,
    _path_is_link_like,
    _workspace_audit_metadata,
)
from .workspace.process_io import (
    _process_group_options as _process_group_options,
    _stop_process,
)
from .workspace.search import (
    SEARCH_MAX_FILE_BYTES as SEARCH_MAX_FILE_BYTES,
    SEARCH_MAX_RAW_EVENTS as SEARCH_MAX_RAW_EVENTS,
)
...
# Compatibility name retained for callers that imported token helpers from this module.
_openai_agentic_token_count = openai_agentic_token_count
...
def resolve_windows_browser_executable(
    ...
    """Compatibility wrapper for the extracted browser transport."""
    return _browser_transport.resolve_windows_browser_executable(selected_browser)
...
def open_agent_in_default_browser(
    ...
    """Compatibility wrapper for the extracted browser transport."""
    return _browser_transport.open_agent_in_default_browser(platform, target_url)
...
def _open_login_in_debug_browser(
    ...
    """Compatibility wrapper for the extracted debug-browser login handoff."""
    return _browser_transport._open_login_in_debug_browser(
        selected_platform,
        selected_browser,
        destination,
    )
...
def open_agent_in_browser(
    ...
    *,
    ...
    """Compatibility wrapper for the extracted browser transport."""
    return _browser_transport.open_agent_in_browser(
        platform,
        browser,
        target_url,
        ...
        _browser_descriptor_loader=browser_descriptors,
        _windows_executable_resolver=resolve_windows_browser_executable,
    )
...
def open_chatgpt_in_default_browser(target_url: str = "") -> dict[str, Any]:
    """Compatibility wrapper for the extracted default-browser transport."""
    return _browser_transport.open_chatgpt_in_default_browser(
        target_url,
        _default_browser_opener=open_agent_in_default_browser,
    )
...
def _capture_macos_frontmost_application() -> str:
    """Compatibility wrapper for the shared host-window helper."""
...
def _restore_macos_frontmost_application_after_task_stage(
    ...
    """Compatibility wrapper for the shared host-window helper."""
    _browser_host._restore_macos_frontmost_application_after_task_stage(
