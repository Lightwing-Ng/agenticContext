...
class WebAppTests(unittest.TestCase):
    ...
    def test_pages_share_the_direct_cache_dock_link(self) -> None:
        ...
        for page_source, body in (
            ...
            with self.subTest(page=page_source):
                ...
                expected_style_version = "style-v2.156.2-codex.0"
        ...
        self.assertIn('settings-directory-picker.js?v=settings-directory-picker-v2.2.1-codex.0', settings_body)
    ...
    def test_agent_control_plane_allows_private_lan_with_password(self) -> None:
        ...
        self.assertIn('style-v2.156.2-codex.0', local_body)
        ...
        self.assertEqual(guide_body.count('<li class="agent-tunnel-guide-item">'), 4)
        self.assertNotIn('agent-tunnel-guide-number', guide_body)
    ...
    def test_agent_status_isolates_a_foreign_running_snapshot_for_the_requested_route(self) -> None:
        ...
        snapshot.update(
            {
                ...
                "agentic_token_method": "utf8_quarter_estimate",
            }
        )
        ...
        self.assertEqual(payload["agent"]["agentic_token_method"], "")
        self.assertEqual(
    ...
    def test_browser_page_and_secure_media_route_use_isolated_cache(self) -> None:
        with TemporaryDirectory() as raw_root:
            ...
            self.assertIn("style-v2.156.2-codex.0", body)
